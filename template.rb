...
@prefs = {:remote_host=>"https://raw.github.com/thegarage/thegarage-template", :remote_branch=>"binstubs", :github_organization=>"thegarage", :github_deployer_account=>"thegarage-deployer", :heroku_app_prefix=>"tg"}
@gems = ["bundler"]
