...
stage_two do
  ...
  recipes = %w(
    ...
    provisioning/roles/gemrc/gemrc
    ...
    provisioning/roles/postgresql/pg_hba.conf
    provisioning/roles/postgresql/pgdg.list
    ...
    provisioning/roles/rails_setup/vm_rails_setup.sh
    ...
    provisioning/roles/set_locale/lang.sh
